    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      >
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-slate-500 dark:text-slate-400 text-sm">Owner investment or capital add</p>
          </div>
        </div>
      ...
      >
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h2 className="text-2xl font-bold text-slate-800 dark:text-white">Cash History</h2>
            <p className="text-slate-500 dark:text-slate-400 text-sm">Previous investments</p>
          </div>
        </div>
